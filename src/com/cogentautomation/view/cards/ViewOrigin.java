...
public class ViewOrigin extends JPanel {
	/**
	 * 
	 */
	...
	public ViewOrigin() {
		...
		panel_2.add(lblEquivilent, "cell 0 4,alignx right");
		
		lblEq = new JLabel("Unknown");
		panel_2.add(lblEq, "flowx,cell 1 4");
		
		JLabel lblArchitecture = new JLabel("Architecture");
		panel_2.add(lblArchitecture, "cell 0 5,alignx trailing");
		...
		panel_2.add(fldArchitechture, "cell 1 5,growx");
		...
		panel_3.add(lblExplanation, "cell 0 0,alignx right,aligny top");
		...
		panel_3.add(fldExplanation, "cell 1 0,grow");
		
		JLabel lblDanger = new JLabel("Danger");
		lblDanger.setAlignmentX(Component.CENTER_ALIGNMENT);
		panel_3.add(lblDanger, "cell 0 1,alignx trailing");
		...
		panel_3.add(panel_7, "cell 1 1,alignx left,growy");
		...
		panel_3.add(fldDanger, "cell 1 2,grow");
