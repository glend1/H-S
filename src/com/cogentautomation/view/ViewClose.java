...
public class ViewClose extends JDialog implements ActionListener {
	...
	public ViewClose() {
		...
		setTitle("Warning!");
		setIconImage(Toolkit.getDefaultToolkit().getImage(ViewClose.class.getResource("/com/cogentautomation/Cogent-Automation-Logo.png")));
